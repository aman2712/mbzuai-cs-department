...
export default function Hero() {
  return (
    <div className="w-screen bg-center bg-cover flex mt-20 justify-center px-32">
      <div className="flex-[0.5]">
        ...
        >
          <p className="text-white/90 max-w-xl mt-8">
            We are advancing the frontiers of artificial intelligence and
            computer science through groundbreaking research and innovative
            education
          </p>
